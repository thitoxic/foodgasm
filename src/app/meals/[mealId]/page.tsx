...
const MealById = ({ params }: any) => {
  ...
  let mealInstructions = meal.instructions.split('\n').filter((step: string) => step.trim() !== '');
    ...
    <div className=" flex justify-center flex-col  items-center">
      <div className="lg:w-2/3 w-full pt-3">
        <div className=" flex lg:flex-row flex-col">
          <div className="p-3">
            <Image className="rounded-lg" src={meal.image} width={400} height={400}/>
          </div>
          ...
          <Link href={`mailto:${meal.creator_email}`} className=" text-lg my-2">{meal.creator_email}</Link>
